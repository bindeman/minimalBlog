...
templates['photoCard'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<section class=\"photo-card\">\n  <div class=\"img-container\">\n    <img class=\"person-photo-img\" src=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"photoURL") || (depth0 != null ? lookupProperty(depth0,"photoURL") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"photoURL","hash":{},"data":data,"loc":{"start":{"line":3,"column":39},"end":{"line":3,"column":51}}}) : helper)))
    + "\" />\n  </div>\n  <div class=\"caption\">\n    "
